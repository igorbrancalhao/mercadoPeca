      ...
      <td width="50%"><!-- Start Table for item details -->
         <table width="100%" border="0" cellspacing="3" cellpadding="3">
            ...
            <tr class="c1">
               ...
               <td class="greenfont"><strong><?=$fees->display_amount($item_details['max_bid'], $item_details['currency']); ?></strong></td>
            </tr>
            <? } ?>
            <? if (!$buyout_only) { ?>
            <tr class="c1">
...
<table width="100%" border="0" cellpadding="3" cellspacing="3" class="border">
   ...
   <tr class="c1">
      ...
      <td class="redfont"><strong><?=$fees->display_amount($item_details['max_bid'], $item_details['currency']); ?></td>
   </tr>
	<? if ($item_details['auction_type']=='dutch') { ?>
	<tr class="c1">
