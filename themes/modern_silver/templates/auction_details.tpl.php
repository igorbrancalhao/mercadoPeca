   ...
   <tr class="contentfont" align="center">
      <td><table width=100%>
            <tr>
               ...
               <td align="center" width="100%"><? if ($item_details['owner_id'] == $session->value('user_id')) { ?>
   ...
   <tr valign="top">
      ...
      <td width="50%"><!-- Start Table for item details -->
         <table width="100%" border="0" cellspacing="2" cellpadding="3">
            ...
            <? } ?>
            <? } ?>
            <? if ($ad_display == 'preview' && $item_details['is_reserve'] && !$buyout_only) { ?>
            <tr class="c1">
               <td><strong>
                  <?=MSG_RES_PRICE;?>
                  </strong></td>
            ...
            <? } ?>
            <? if ($ad_display == 'live' && !$buyout_only && !$item_details['closed']) { ?>
            <tr class="c1">
               <td><b>
                  <?=MSG_HIGH_BID; ?>
                  </b></td>
   ...
   <form action="bid.php" method="post">
      ...
      <tr class="c1">
         ...
         <td><strong>
            ...
            &nbsp;
            <?=MSG_MINIMUM_BID;?>
            : <strong><? echo $fees->display_amount($item->min_bid_amount($item_details), $item_details['currency']);?></strong></td>
      </tr>
      <tr class="c2">
         <td align="right"></td>
