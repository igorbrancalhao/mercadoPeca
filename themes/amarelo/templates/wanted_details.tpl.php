...
<table width="100%" border="0" cellpadding="0" cellspacing="0" background="themes/<?=$setts['default_theme'];?>/images/bar_bg.gif">
                  <tr>
                    ...
                    <td width="38%" align="right" valign="middle" class="view"><?=MSG_WANTED_AD_ID;?>: <b><?=$item_details['wanted_ad_id'];?></td>
                  </tr>
                </table>
<br>
<?=$msg_changes_saved;?>
