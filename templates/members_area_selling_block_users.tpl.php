...
<table width="100%" border="0" cellpadding="3" cellspacing="2" class="border">
	<tr>
      <td colspan="4" class="c7"><b><?=MSG_MM_BLOCK_USERS;?></b>
      </td>
   </tr>
   <tr>
   ...
   <? if ($nb_items>0) { ?>
   <tr>
      <td colspan="4" align="center" class="contentfont"><?=$pagination;?></td>
   </tr>
	<? } ?>
   <tr class="c4">
   ...
   <tr class="contentfont">
      <td colspan="4">[ <a href="members_area.php?page=selling&section=block_users&do=add_user"><?=MSG_ADD_USER;?></a> ]</td>
   </tr>
</table>
