...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="21" style="border-bottom: 2px solid #9c9c9c;">
   <tr>
      ...
      <td width="100%" background="themes/<?=$setts['default_theme'];?>/img/5_bg.gif" valign="bottom" style="padding-left: 5px; padding-bottom: 3px;"><b style="color: #333333; font-size: 12px;">
         <?=MSG_VIEW_MEMBER_PROFILE;?>
         </b></td>
