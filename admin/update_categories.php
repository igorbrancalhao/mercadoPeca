...
else
{
	...
	include_once ('header.php');## PHP Pro Bid v6.00$link = 'category_language.php';
	$link = 'index.php';## PHP Pro Bid v6.00 temporary until we create the multilanguage engine
