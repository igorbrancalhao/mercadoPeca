...
<table width="100%" border="0" cellpadding="3" cellspacing="3" class="fside">
   <form name="form_general_settings" method="post" action="general_settings.php">
      ...
      <tr class="c1">
         ...
         <td><input name="images_max_size" type="text" id="images_max_size" value="<?=$setts_tmp['images_max_size'];?>" size="8" maxlength="4">
            KBytes </td>
      </tr>
      <tr>
         <td align="right" class="explain"><img src="images/info.gif"></td>
      ...
      <tr class="c1">
         <td align="right"><?=AMSG_MAX_FILE_SIZE;?></td>
         <td><input name="media_max_size" type="text" id="media_max_size" value="<?=$setts_tmp['media_max_size'];?>" size="8" maxlength="4">
            KBytes </td>
      </tr>
      <tr>
         <td align="right" class="explain"><img src="images/info.gif"></td>
