         ...
         <table width="100%" border="0" cellpadding="2" cellspacing="2" class="fside">
            <tr>
               <td width="100%" class="menulink">
                  ...
                  <img src="images/a.gif" align="absmiddle" vspace="2"> <a href="../initialize_counters.php" target="_blank"><?=AMSG_INITIALIZE_COUNTERS;?></a> </td>
            </tr>
         </table>
         <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
         ...
         <table width="100%" border="0" cellpadding="2" cellspacing="2" class="fside">
            <tr>
               <td width="100%" class="menulink">
                  ...
                  <img src="images/a.gif" align="absmiddle" vspace="2"> <a href="general_settings.php?page=invoices_settings"><?=AMSG_INVOICES_SETTINGS;?></a> </td>
            </tr>
         </table>
         <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
         ...
         <table width="100%" border="0" cellpadding="2" cellspacing="2" class="fside">
            <tr>
               <td width="100%" class="menulink">
                  ...
                  <img src="images/a.gif" align="absmiddle" vspace="2"> <a href="enable_disable.php?page=second_chance"><?=AMSG_ENABLE_SECOND_CHANCE;?></a> </td>
            </tr>
         </table>
         <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
         ...
         <table width="100%" border="0" cellpadding="2" cellspacing="2" class="fside">
            <tr>
               <td width="100%" class="menulink">
                  ...
                  <img src="images/a.gif" align="absmiddle" vspace="2"> <a href="table_currencies.php"><?=AMSG_CURRENCY_SETTINGS;?></a>
                  <!--
         ...
         <table width="100%" border="0" cellpadding="2" cellspacing="2" class="fside">
            <tr>
               <td width="100%" class="menulink">
                  ...
                  <img src="images/a.gif" align="absmiddle" vspace="2"> <a href="table_bid_increments.php"><?=AMSG_EDIT_BID_INCREMENTS;?></a> </td>
            </tr>
         </table>
         <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
         ...
         <table width="100%" border="0" cellpadding="2" cellspacing="2" class="fside">
            <tr>
               <td width="100%" class="menulink">
                  ...
                  <img src="images/a.gif" align="absmiddle" vspace="2"> <a href="tax_settings.php"><?=AMSG_TAX_CONFIGURATION;?></a> </td>
            </tr>
         </table>
         <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
