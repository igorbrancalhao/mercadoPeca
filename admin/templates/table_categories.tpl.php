   ...
   <form action="table_categories.php" method="post">
      ...
      <tr valign="top">
         <td align="center" style="padding: 3px;"><input type="submit" name="form_save_settings" value="<?=AMSG_SAVE_CHANGES;?>">
            &nbsp;
            &nbsp;
            <input name="form_generate_subcategories" type="submit" value="<?=AMSG_GENERATE_CATEGORIES;?>"></td>
      </tr>
      <tr valign="top" class="c1">
         <td><img src="images/info.gif" align="absmiddle"> <?=AMSG_CATEGORIES_GENERATE_NOTE;?></td>
      </tr>
   </form>
</table>
<table width="100%" border="0" cellpadding="0" cellspacing="0">
