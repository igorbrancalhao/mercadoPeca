...
define('DEFAULT_DB_LANGUAGE', 'portugues');
...
$install_step = (isset($_REQUEST['install_step'])) ? $_REQUEST['install_step'] : 'welcome';

if (isset($_REQUEST['btn_refresh'])) {
...
if ($install_step == 'welcome') { ## first step
    ...
    $page_content = '<p><b>Bem vindo - hostmp.net </b></p> ' .
    ...
    $v605_steps = 4; ## 6.04 to 6.05 upgrade

    switch ($_REQUEST['install_type']) {
        case 'install':
            $total_steps = 74 + $v600_steps + $v603_steps + $v604_steps + $v605_steps;
            break;
        case 'upgrade_v525':
            $total_steps = 177 + $v600_steps + $v603_steps + $v604_steps + $v605_steps;
            break;
        case 'upgrade_v600':
            $total_steps = $v600_steps + $v603_steps + $v604_steps;
            break;
        case 'upgrade_v602':
            $total_steps = $v603_steps + $v604_steps + $v605_steps;
            break;
        case 'upgrade_v603':
            $total_steps = $v604_steps + $v605_steps;
            break;
        case 'upgrade_v604':
            $total_steps = $v605_steps;
            break;
    }
    ...
    $page_content = '<p><b>Installation Successful</b></p> ' .
            '<p>Ofere�a a melhor hospedagem para seu site http://hostmp.net</p>';
