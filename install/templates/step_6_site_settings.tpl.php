...
<table width="100%" border="0" cellpadding="3" cellspacing="2" class="border">
    ...
    <tr class="c5">
        <?php if (isset($setts['default_theme'])) { ?>
    ...
    <tr class="c1">
        ...
        <td class="contentfont"><input name="sitename" type="text" id="sitename" value="<?= (isset($setts['sitename'])) ? $setts['sitename'] : ""; ?>" size="40" /></td>
    </tr>
    <tr class="reguser">
        <td>&nbsp;</td>
    ...
    <tr class="c1">
        ...
        <td class="contentfont"><input name="site_path" type="text" class="contentfont" id="site_path" value="<?php echo isset($setts['site_path']) ? $setts['site_path'] : 'http://'; ?>" size="40" /></td>
    </tr>
    <tr class="reguser">
    ...
    <tr class="c1">
        ...
        <td class="contentfont"><input name="admin_email" type="text" id="admin_email" value="<?= (isset($setts['admin_email'])) ? $setts['admin_email'] : ""; ?>" size="40" /></td>
    </tr>
    <tr class="reguser">
        <td>&nbsp;</td>
