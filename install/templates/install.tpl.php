...
<html>
    <head>
        <title>PHP Pro Bid v6.00 Installation</title>
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td width="100%"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" background="templates/img/headbg.gif">
                    ...
                    <br>
                    <div style="border-top: 2px solid #a6a6a6;">
                        <?php if (isset($setts['default_theme'])) { ?>
                            <img src="themes/<?= $setts['default_theme']; ?>/img/pixel.gif" width="1" height="5">
                        <?php } ?>
                    </div>
                    <div align="center" class="footerfont1"> Copyright &copy;2007 <strong>PHP Pro Software LTD</strong>. All Rights Reserved.<br>Designated trademarks and brands are the property of their respective owners.<br>
                    </div></td>
            </tr>
        </table>
    </body>
