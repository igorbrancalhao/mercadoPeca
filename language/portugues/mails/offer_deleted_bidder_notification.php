...
A %2$s oferta que você fez em %3$s foi removida pelo vendedor.

Para mais detalhes, por favor, siga a URL abaixo:
...
<br>
A %2$s oferta que você fez em %3$s foi removida pelo vendedor. <br>
<br>
[ <a href="%4$s">Clique aqui</a> ] para mais detalhes. <br>
<br>
Atenciosamente,
Equipe %5$s';
...
send_mail($row_details['email'], 'ID do Anúncio: ' . $offer_details['auction_id'] . ' - Oferta Rejeitada', $text_message,
